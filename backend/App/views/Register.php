                ...
                <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                    ...
                    <ul class="navbar-nav d-lg-block d-none">
                        <li class="nav-item">
                            ...
                            <a href="https://register.dualdisorderswaddmexico2022.com/Register/" class="flag-cont" onclick="smoothToPricing('pricing-soft-ui')">
                                        ...
                                        <div class="multisteps-form">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-lg-12 m-auto">
                                                    <form class="multisteps-form__form" id="add" action="/Registro/Success" method="POST">
                                                        <!--single form panel-->
                                                            ...
                                                            <div class="multisteps-form__content">
                                                                ...
                                                                <div class="row mt-3">
                                                                    <div class="col-12 col-sm-6">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control all_input" type="email" id="email" name="email" placeholder="ej. user@domain.com" autocomplete="no">
                                                                    ...
                                                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control all_input all_email" type="email" id="confirm_email" name="confirm_email" placeholder="ej. user@domain.com" disabled autocomplete="no">
                                                                ...
                                                                <div class="row mt-3">
                                                                    ...
                                                                    <div class="col-12 col-sm-4">
                                                                        <label>Nombre *</label>
                                                                        <input class="multisteps-form__input form-control all_input" type="text" id="name_user" name="name_user" maxlength="15" placeholder="ej. Christopher" required style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no" disabled >
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                                        <label>Segundo Nombre</label>
                                                                        <input class="multisteps-form__input form-control" type="text" id="middle_name" name="middle_name" maxlength="15" placeholder="ej. Prior" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-3">
                                                                    <div class="col-12 col-sm-5">
                                                                        <label>Primer apellido *</label>
                                                                        <input class="multisteps-form__input form-control all_input" type="text" id="surname" name="surname" maxlength="15" placeholder="ej. Jones" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no" disabled>
                                                                    </div>
                                                                    <div class="col-12 col-sm-5">
                                                                        <label>Segundo apellido</label>
                                                                        <input class="multisteps-form__input form-control" type="text" id="second_surname" name="second_surname" maxlength="15" placeholder="ej. Wilson" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no" disabled>
                                                                    </div>
                                                                    <div class="col-12 col-sm-2">
                                                            ...
                                                            <div class="multisteps-form__content">
                                                                <div class="row mt-3">
                                                                    <div class="col">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control all_input_second" type="text" maxlength="35" id="organization" name="organization" placeholder="ej. Asociado APM" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no">
                                                                    </div>
                                                                    <div class="col">
                                                                        <label>Puesto *</label>
                                                                        <input class="multisteps-form__input form-control all_input_second" type="text" maxlength="25" id="position" name="position" placeholder="ej. Asociado" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no">
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-3">
                                                                    <div class="col-12 col-sm-6">
                                                                        <label>Dirección</label>
                                                                        <input class="multisteps-form__input form-control" type="text" id="address" maxlength="50" name="address" placeholder="ej. Periferico sur 4194 Desp 104 Col. Jardines del Pedregal." style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-6 col-sm-3 mt-3 mt-sm-0">
                                                                        <div class="col-12 col-sm-6">
                                                                            <label>C.P *</label>
                                                                            <input class="multisteps-form__input form-control" type="text" id="organization_postal_code" name="organization_postal_code" maxlength="5" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ej. 50398" autocomplete="no">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="multisteps-form__content mt-3">
                                                                <div class="row mt-3">
                                                                    ...
                                                                    <div class="col-12 col-sm-4">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control" type="text" id="scholarship" name="scholarship" maxlength="10" placeholder="ej. XXX0X0X0X0" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="no">
                                                                    </div>
                                                        ...
                                                        <div id="card_three" class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                                                            <div class="row text-center">
                                                                <div class="col-10 mx-auto">
                                                                    <h5 class="font-weight-normal">FORMA DE PAGO</h5>
                                                                    <p>Tendrás un máximo de 5 días para realizar tu pago y subir tu comprobante al sistema. Completar el formulario con  sus datos de IVA. Si requiere un recibo deducible de impuestos.</p>
                                                                </div>
                                                            </div>
                                                            <div class="multisteps-form__content row text-center">
                                                                <div class="row mt-4 row text-center">
                                                                    ...
                                                                    <div class="col-sm-3 me-auto">
                                                                        ...
                                                                        <h6>Tarjeta de Crédito ó Débito</h6>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                                <div class="row text-center">
                                                        ...
                                                        <div id="card_four" class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                                                            <div class="row text-center">
                                                                <div class="col-10 mx-auto">
                                                                    <h5 class="font-weight-normal">Forma de pago</h5>
                                                                    <p>Tendrás un máximo de 5 días para realizar tu pago y subir tu comprobante al sistema. Y Completar el formulario con  sus datos de IVA Si requiere un recibo deducible de impuestos.</p>
                                                                </div>
                                                            </div>
                                                            <div class="multisteps-form__content">
                                                                <div class="row mt-4">
                                                                ...
                                                                <div class="row mt-0">
                                                                    <div class="row mt-1">
                                                                        <div class="col-12 col-sm-4">
                                                                            ...
                                                                            <input class="multisteps-form__input form-control all_input_finalize" type="text" id="business_name_iva" name="business_name_iva" placeholder="ej. Christopher Prior Jones" maxlength="20" onfocus="focused(this)" onfocusout="defocused(this)" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                                        </div>
                                                                        <div class="col-12 col-sm-4 mt-1 mt-sm-0">
                                                                            <label>RFC *</label>
                                                                            <input class="multisteps-form__input form-control all_input_finalize" type="text" id="code_iva" name="code_iva" placeholder="ej. CPJ41250AS" maxlength="13" onfocus="focused(this)" onfocusout="defocused(this)" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                                        </div>
                                                                        <!-- <div class="col-12 col-sm-4 mt-1 mt-sm-0">
                                                                    ...
                                                                    <div class="row mt-1">
                                                                        <div class="col-12 col-sm-5">
                                                                            ...
                                                                            <input class="multisteps-form__input form-control all_input_finalize" type="text"  id="email_receipt_iva" name="email_receipt_iva" placeholder="ej. user@domain.com" onfocus="focused(this)" onfocusout="defocused(this)">
                                                                            <span class="mb-0 text-sm" id="error_email_send" style="display:none;color:red;">Correo Electrónico incorrecto</span>
                                                                        </div>
                                                                        <div class="col-12 col-sm-2">
                                                                            <label>C.P *</label>
                                                                            <input class="multisteps-form__input form-control all_input_finalize" type="text" id="postal_code_iva" name="postal_code_iva" maxlength="5" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ej. 50398">
                                                                        </div>
                                                                        <div class="col-12 col-sm-4 mt-1 mt-sm-0">
                                                                            <label>Método de pago *</label>
                                                                            <select class="multisteps-form__select form-control all_input_finalize_select" name="payment_method_iva" id="payment_method_iva">
                                                                                <option value="" disabled selected>Selecciona una Opción</option>
                                                                                <option value="ELECTRONIC TRANSFER">TRANSFERENCIA ELECTRONICA</option>
                                                                    ...
                                                                    <div class="button-row d-flex mt-1">
                                                                        <button class="btn bg-gradient-success ms-auto mb-0" id="finalize" type="button" onclick="myFunction_TermsConditions()" disabled>Finalizar</button>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">MUY IMPORTANTE</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn bg-gradient-success" onclick="myFunction()">SI</button>
                </div>
            </div>
        </div>
    </div>
